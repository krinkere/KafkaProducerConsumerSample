...
public class KafkaConsumer {
    public static void main(String args[]) {
        ...
        long maxNumOfReads = Long.parseLong("10");
        String topicName = "my_test_topic"; //args[1];
        int partitionToReadFrom = 0;
        List<String> brokerHostNames = new ArrayList<String>();
        brokerHostNames.add("192.168.33.21");
        int brokerPostNumber = Integer.parseInt("9092");
        try {
            example.run(maxNumOfReads, topicName, partitionToReadFrom, brokerHostNames, brokerPostNumber);
        } catch (Exception e) {
